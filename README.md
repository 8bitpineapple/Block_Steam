# Block_Steam
A Batch file script to toggle Steams access to the internet. <span style="font-size: larger;"> [Download](https://github.com/8bitpineapple/Block_Steam/releases/download/v1.0.0/Block_Steam.bat)</span>
