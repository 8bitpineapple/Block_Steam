...
# To use:
[Download]([https://github.com/8bitpineapple/Block_Steam/blob/main/Block_Steam.bat](https://github.com/8bitpineapple/Block_Steam/releases/download/v1.0.0/Block_Steam.bat)) the batch file Block_Steam.bat
